...
public class TurfController {
	...
	@GetMapping("/getturfbyadd/{turfAdd}")
	public ResponseEntity<List<Turf>> getTurfByAdd(@PathVariable String turfAdd){
		List<Turf> turfList = turfService.getTurfByAdd(turfAdd);
