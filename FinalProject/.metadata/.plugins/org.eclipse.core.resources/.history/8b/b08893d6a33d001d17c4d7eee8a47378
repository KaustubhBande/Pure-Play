...
public class MySecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/api/users/adduser","/api/users/getuserbyemail/**","/api/turfs/getturfbyadd/**","/api/users/getuser/**","/api/users/updateuser/**").permitAll()
		.antMatchers(HttpMethod.OPTIONS).permitAll()
		.antMatchers("/api/bookings/getbookingsofuser/**","/api/bookings/add","/api/bookings/delete/**","/api/bookings/get/**").hasRole("USER")
